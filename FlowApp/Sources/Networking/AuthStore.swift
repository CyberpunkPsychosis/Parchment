...
final class AuthStore: ObservableObject {
    ...
    func updateProfile(nickname: String?, avatarURL: String?, bio: String?, city: String? = nil) async {
        if let u = try? await APIClient.shared.updateSettings(nickname: nickname, avatarURL: avatarURL, bio: bio, city: city) {
            user = u
        }
    }
